...
public class Day12_ListerersTest2 implements ITestListener, IReporter, IInvokedMethodListener, IAnnotationTransformer
 {
	@Override
	public void transform(ITestAnnotation annotation, Class testClass, Constructor testConstructor, Method testMethod) 
	 {
	  annotation.setRetryAnalyzer(TestNGPrograms.Day12_RetryAnalyzer.class);
	 }
